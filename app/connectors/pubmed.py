...
class PubMedConnector(BaseConnector):
    ...
    async def _fetch_batch(self, pmids: list[str]) -> list[NormalizedPaper]:
        params = {
            "db": "pubmed",
            "id": ",".join(pmids),
            "retmode": "xml",
    ...
    def _parse_xml(self, xml_text: str) -> list[NormalizedPaper]:
        papers = []
        try:
    ...
    def _parse_article(self, node: ET.Element) -> Optional[NormalizedPaper]:
